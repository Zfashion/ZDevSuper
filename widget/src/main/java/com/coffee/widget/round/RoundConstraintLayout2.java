...
import com.coffee.widget.round.helper.RoundHelper2;
import com.coffee.widget.round.helper.RoundHelperImpl2;
import com.coffee.widget.round.helper.RoundMethodInterface2;

/**
 * @author kuanggang on 2019/12/10
 */
public class RoundConstraintLayout2 extends ConstraintLayout implements RoundMethodInterface2 {

    private final RoundHelper2 mHelper = new RoundHelperImpl2();
