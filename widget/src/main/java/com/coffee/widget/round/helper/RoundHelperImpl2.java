 ...
 */
public class RoundHelperImpl2 implements RoundHelper2 {
    ...
    public void setRadius(float radiusTopLeftDp, float radiusTopRightDp, float radiusBottomLeftDp, float radiusBottomRightDp) {
        ...
        mRadiusTopLeft = DensityUtil.INSTANCE.dp2px(radiusTopLeftDp);
        mRadiusTopRight = DensityUtil.INSTANCE.dp2px(radiusTopRightDp);
        mRadiusBottomLeft = DensityUtil.INSTANCE.dp2px(radiusBottomLeftDp);
        mRadiusBottomRight = DensityUtil.INSTANCE.dp2px(radiusBottomRightDp);
        if (mView != null) {
            onSizeChanged(mWidth, mHeight);
            mView.invalidate();
        }
    ...
    public void setRadiusTopLeft(float radiusDp) {
        ...
        mRadiusTopLeft = DensityUtil.INSTANCE.dp2px(radiusDp);
        if (mView != null) {
            onSizeChanged(mWidth, mHeight);
            mView.invalidate();
        }
    ...
    public void setRadiusTopRight(float radiusDp) {
        ...
        mRadiusTopRight = DensityUtil.INSTANCE.dp2px(radiusDp);
        if (mView != null) {
            onSizeChanged(mWidth, mHeight);
            mView.invalidate();
        }
    ...
    public void setRadiusBottomLeft(float radiusDp) {
        ...
        mRadiusBottomLeft = DensityUtil.INSTANCE.dp2px(radiusDp);
        if (mView != null) {
            onSizeChanged(mWidth, mHeight);
            mView.invalidate();
        }
    ...
    public void setRadiusBottomRight(float radiusDp) {
        ...
        mRadiusBottomRight = DensityUtil.INSTANCE.dp2px(radiusDp);
        if (mView != null) {
            onSizeChanged(mWidth, mHeight);
            mView.invalidate();
        }
    ...
    public void setStrokeWidth(float widthDp) {
        ...
        mStrokeWidth = DensityUtil.INSTANCE.dp2px(widthDp);
        if (mView != null) {
            onSizeChanged(mWidth, mHeight);
            mView.invalidate();
        }
